    ...
    where TEntity : class, IEntity, new()
{
    ...
    // Batch operations
    Task CreateAsBatchAsync(IEnumerable<TEntity> entities, int batchSize = 100, CancellationToken cancellationToken = default);
    Task UpdateAsBatchAsync(IEnumerable<TEntity> entities, int batchSize = 100, CancellationToken cancellationToken = default);
    Task DeleteAsBatchAsync(IEnumerable<TEntity> entities, int batchSize = 100, CancellationToken cancellationToken = default);
}
